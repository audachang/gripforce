...
gpdir = 'subject_results/group.young/group_results';
datadir = 'test.CSPLIN.3dMEMA_N=77.results';
...
T1_nii_pth = fullfile(rootdir, gpdir, datadir, T1_nii_fn);
T1_nii_iso_pth = fullfile(rootdir, gpdir, datadir, join({'c', T1_nii_fn{1}}, '_'));
T1_nii_gray_pth = fullfile(rootdir, gpdir, datadir, T1_gray_nii_fn);
T1_nii_white_pth = fullfile(rootdir, gpdir, datadir, T1_white_nii_fn);
